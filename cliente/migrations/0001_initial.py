    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.CharField(max_length=200, verbose_name='Nome Completo')),
                ('contato', models.CharField(max_length=200, verbose_name='Nome Contato')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logradouro_obra', models.CharField(blank=True, max_length=200, verbose_name='Logradouro')),
                ('numero_obra', models.CharField(blank=True, max_length=30, verbose_name='Número')),
                ('complemento_obra', models.CharField(blank=True, max_length=100, verbose_name='Complemento')),
                ('cep_obra', models.CharField(blank=True, max_length=11, verbose_name='CEP')),
                ('estado_obra', models.CharField(blank=True, choices=[('AC', 'AC'), ('AL', 'AL'), ('AP', 'AP'), ('AM', 'AM'), ('BA', 'BA'), ('CE', 'CE'), ('DF', 'DF'), ('ES', 'ES'), ('GO', 'GO'), ('MA', 'MA'), ('MT', 'MT'), ('MS', 'MS'), ('MG', 'MG'), ('PA', 'PA'), ('PB', 'PB'), ('PE', 'PE'), ('PI', 'PI'), ('PR', 'PR'), ('RJ', 'RJ'), ('RN', 'RN'), ('RO', 'RO'), ('RR', 'RR'), ('RS', 'RS'), ('SC', 'SC'), ('SE', 'SE'), ('SP', 'SP'), ('TO', 'TO')], max_length=2, verbose_name='Estado')),
                ('cidade_obra', models.CharField(blank=True, max_length=100, verbose_name='Cidade')),
