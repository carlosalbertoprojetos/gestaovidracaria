    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tel_residencial', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region=None, unique=True, verbose_name='Telefone Residencial')),
                ('tel_celular', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region=None, unique=True, verbose_name='Telefone Celular')),
                ...
                ('banco', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='banco.banco', verbose_name='Banco')),
            ],
        ),
        migrations.CreateModel(
            name='Filho',
