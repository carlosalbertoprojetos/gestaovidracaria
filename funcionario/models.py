...
from tourproject.constantes import STATE_CHOICES,SEXO_CHOICES, RACA_CHOICES
...
class Filho(models.Model):
    ...
    funcionario = models.ForeignKey(Funcionario, on_delete=models.DO_NOTHING, verbose_name='Funcionário')
    nome = models.CharField('Nome Completo', max_length=200)
