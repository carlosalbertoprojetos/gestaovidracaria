    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descricao', models.TextField(blank=True, verbose_name='Descrição')),
                ('valor_custo', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10, verbose_name='Valor de Custo')),
                ('valor_venda', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10, verbose_name='valor de Venda')),
                ('disponivel', models.BooleanField(default=True, verbose_name='Disponível')),
                ('quantidade', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10, verbose_name='Quantidade de Produto')),
