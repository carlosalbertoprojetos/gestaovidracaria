...
class Produto(models.Model):
    ...
    descricao = models.TextField('Descrição', blank=True)
    valor_custo = models.DecimalField('Valor de Custo', max_digits=10, decimal_places=2, default=0, blank=True)
    valor_venda = models.DecimalField('valor de Venda', max_digits=10, decimal_places=2, default=0, blank=True)
    disponivel = models.BooleanField('Disponível', default=True)
    quantidade = models.DecimalField('Quantidade de Produto', max_digits=10, decimal_places=2, default=0, blank=True)
